    ...
    >
      ...
      >
        ...
        >
          ...
          <Link href={"/about"}>
            <Text _hover={{ textDecoration: "underline" }}>О нас</Text>
          </Link>
          <Link href={"/info?tab=0"}>
            <Text _hover={{ textDecoration: "underline" }}>Оптовикам</Text>
          </Link>
          <Link href={"/info?tab=1"}>
            <Text _hover={{ textDecoration: "underline" }}>Способы оплаты</Text>
          </Link>
        ...
        >
          ...
          {data.addresses[0] && (
            ...
            >
              ...
              <Link href={data.addresses[0].map_link} target="_blank">
                <Text
                  fontWeight={"700"}
          ...
          {data.work_schedules[0] && (
            ...
            >
              ...
              <Text fontWeight={"700"}>
                с {data.work_schedules[0].start} до {data.work_schedules[0].end}
              </Text>
            </Flex>
          )}
          <Flex
          ...
          >
            ...
            <Link
              href={`https:/wa.me/${data.phones[0].phone.replace(
                /[()\s-]/g,
                ""
              )}`}
              target="_blank"
          ...
          <Flex flexDir={"row"} gap={"20px"}>
            {data.social_links.length > 0 &&
              data.social_links.map((link) => (
                <Link key={link.id} href={link.url ? link.url : "#"} target="_blank">
                  <Image
                    src={link.logo ? link.logo : "/evelin-logo.jpeg"}
                    alt={link.name}
                    width={36}
                    height={36}
